...
# experiments_encode=(
#     "ENCSR958BEA" # Guckelberger et al. 2024, HCT116, RAD21 0hr
#     "ENCSR087JOM" # Guckelberger et al. 2024, HCT116, RAD21 6hr
#     "ENCSR916MFV" # ENCODE, GM12878 intact
#     "ENCSR545YBD" # Rao et al. 2014, K562
#     "ENCSR479XDG" # ENCODE, K562, intact Hi-C
# )


# Download ENCODE experiments 
# echo "Downloading ENCODE experiments"
# for exp in "${experiments_encode[@]}"; do
# echo "-- Experiment ${exp}"
# curl -s -H "Accept: application/json" \
#         "https://www.encodeproject.org/experiments/${exp}/?format=json" \
#     | jq -r '.files[] | select(.file_format=="hic") | .href' \
#     | while read -r href; do
#         fname="$(basename "$href")"
#         echo "* ${fname}"
#         wget -c -P "${DOWNLOAD_DIR}" "https://www.encodeproject.org${href}"
#     done
# done
